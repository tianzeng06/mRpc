...
const MessageType MessageType_MIN = UNKNOW;
...
class RpcMessage : public ::google::protobuf::Message {
 public:
  ...
  // optional .mRpc.MessageType type = 1;
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::mRpc::MessageType type() const;
  inline void set_type(::mRpc::MessageType value);
  ...
  // optional .mRpc.ErrorCode error = 7;
  inline bool has_error() const;
  inline void clear_error();
  static const int kErrorFieldNumber = 7;
  inline ::mRpc::ErrorCode error() const;
  inline void set_error(::mRpc::ErrorCode value);

  // @@protoc_insertion_point(class_scope:mRpc.RpcMessage)
 private:
...
inline ::mRpc::MessageType RpcMessage::type() const {
  // @@protoc_insertion_point(field_get:mRpc.RpcMessage.type)
  return static_cast< ::mRpc::MessageType >(type_);
}
inline void RpcMessage::set_type(::mRpc::MessageType value) {
  assert(::mRpc::MessageType_IsValid(value));
  set_has_type();
  type_ = value;
  // @@protoc_insertion_point(field_set:mRpc.RpcMessage.type)
}
...
inline ::google::protobuf::uint64 RpcMessage::id() const {
  // @@protoc_insertion_point(field_get:mRpc.RpcMessage.id)
  return id_;
}
inline void RpcMessage::set_id(::google::protobuf::uint64 value) {
  set_has_id();
  id_ = value;
  // @@protoc_insertion_point(field_set:mRpc.RpcMessage.id)
}
...
inline const ::std::string& RpcMessage::service() const {
  // @@protoc_insertion_point(field_get:mRpc.RpcMessage.service)
  return *service_;
}
inline void RpcMessage::set_service(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:mRpc.RpcMessage.service)
}
inline void RpcMessage::set_service(const char* value) {
  ...
  service_->assign(value);
  // @@protoc_insertion_point(field_set_char:mRpc.RpcMessage.service)
}
inline void RpcMessage::set_service(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:mRpc.RpcMessage.service)
}
inline ::std::string* RpcMessage::mutable_service() {
  ...
  // @@protoc_insertion_point(field_mutable:mRpc.RpcMessage.service)
  return service_;
}
...
inline void RpcMessage::set_allocated_service(::std::string* service) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mRpc.RpcMessage.service)
}
...
inline const ::std::string& RpcMessage::method() const {
  // @@protoc_insertion_point(field_get:mRpc.RpcMessage.method)
  return *method_;
}
inline void RpcMessage::set_method(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:mRpc.RpcMessage.method)
}
inline void RpcMessage::set_method(const char* value) {
  ...
  method_->assign(value);
  // @@protoc_insertion_point(field_set_char:mRpc.RpcMessage.method)
}
inline void RpcMessage::set_method(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:mRpc.RpcMessage.method)
}
inline ::std::string* RpcMessage::mutable_method() {
  ...
  // @@protoc_insertion_point(field_mutable:mRpc.RpcMessage.method)
  return method_;
}
...
inline void RpcMessage::set_allocated_method(::std::string* method) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mRpc.RpcMessage.method)
}
...
inline const ::std::string& RpcMessage::request() const {
  // @@protoc_insertion_point(field_get:mRpc.RpcMessage.request)
  return *request_;
}
inline void RpcMessage::set_request(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:mRpc.RpcMessage.request)
}
inline void RpcMessage::set_request(const char* value) {
  ...
  request_->assign(value);
  // @@protoc_insertion_point(field_set_char:mRpc.RpcMessage.request)
}
inline void RpcMessage::set_request(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:mRpc.RpcMessage.request)
}
inline ::std::string* RpcMessage::mutable_request() {
  ...
  // @@protoc_insertion_point(field_mutable:mRpc.RpcMessage.request)
  return request_;
}
...
inline void RpcMessage::set_allocated_request(::std::string* request) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mRpc.RpcMessage.request)
}
...
inline const ::std::string& RpcMessage::response() const {
  // @@protoc_insertion_point(field_get:mRpc.RpcMessage.response)
  return *response_;
}
inline void RpcMessage::set_response(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:mRpc.RpcMessage.response)
}
inline void RpcMessage::set_response(const char* value) {
  ...
  response_->assign(value);
  // @@protoc_insertion_point(field_set_char:mRpc.RpcMessage.response)
}
inline void RpcMessage::set_response(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:mRpc.RpcMessage.response)
}
inline ::std::string* RpcMessage::mutable_response() {
  ...
  // @@protoc_insertion_point(field_mutable:mRpc.RpcMessage.response)
  return response_;
}
...
inline void RpcMessage::set_allocated_response(::std::string* response) {
  ...
  // @@protoc_insertion_point(field_set_allocated:mRpc.RpcMessage.response)
}
...
inline ::mRpc::ErrorCode RpcMessage::error() const {
  // @@protoc_insertion_point(field_get:mRpc.RpcMessage.error)
  return static_cast< ::mRpc::ErrorCode >(error_);
}
inline void RpcMessage::set_error(::mRpc::ErrorCode value) {
  assert(::mRpc::ErrorCode_IsValid(value));
  set_has_error();
  error_ = value;
  // @@protoc_insertion_point(field_set:mRpc.RpcMessage.error)
}
...
template <> struct is_proto_enum< ::mRpc::MessageType> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mRpc::MessageType>() {
  return ::mRpc::MessageType_descriptor();
}
template <> struct is_proto_enum< ::mRpc::ErrorCode> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::mRpc::ErrorCode>() {
  return ::mRpc::ErrorCode_descriptor();
}
